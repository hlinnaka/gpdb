...
DATA(insert (	405		cdbhash_bpchar_ops	PGNSP PGUID 7105 1042 f 0 ));
DATA(insert (	405		cdbhash_bytea_ops	PGNSP PGUID 7106 17 f 0 ));
DATA(insert (	405		cdbhash_name_ops	PGNSP PGUID 7107 19 f 0 ));
DATA(insert (	405		cdbhash_oid_ops		PGNSP PGUID 7108 26 f 0 ));
DATA(insert (	405		cdbhash_tid_ops		PGNSP PGUID 7109 27 f 0 ));
DATA(insert (	405		cdbhash_timestamp_ops	PGNSP PGUID 7110 1114 f 0 ));
DATA(insert (	405		cdbhash_timestamptz_ops	PGNSP PGUID 7111 1184 f 0 ));
DATA(insert (	405		cdbhash_date_ops	PGNSP PGUID 7112 1082 f 0 ));
DATA(insert (	405		cdbhash_time_ops	PGNSP PGUID 7113 1083 f 0 ));
DATA(insert (	405		cdbhash_timetz_ops	PGNSP PGUID 7114 1266 f 0 ));
DATA(insert (	405		cdbhash_interval_ops	PGNSP PGUID 7115 1186 f 0 ));
DATA(insert (	405		cdbhash_abstime_ops	PGNSP PGUID 7116 702 f 0 ));
DATA(insert (	405		cdbhash_reltime_ops	PGNSP PGUID 7117 703 f 0 ));
DATA(insert (	405		cdbhash_tinterval_ops	PGNSP PGUID 7118 704 f 0 ));
DATA(insert (	405		cdbhash_inet_ops	PGNSP PGUID 7119 869 f 0 ));
DATA(insert (	405		cdbhash_macaddr_ops	PGNSP PGUID 7120 829 f 0 ));
DATA(insert (	405		cdbhash_bit_ops		PGNSP PGUID 7121 1560 f 0 ));
DATA(insert (	405		cdbhash_varbit_ops	PGNSP PGUID 7122 1562 f 0 ));
DATA(insert (	405		cdbhash_bool_ops	PGNSP PGUID 7123 16 f 0 ));
DATA(insert (	405		cdbhash_array_ops	PGNSP PGUID 7124 2277 f 0 ));
DATA(insert (	405		cdbhash_oidvector_ops	PGNSP PGUID 7125 30 f 0 ));
DATA(insert (	405		cdbhash_cash_ops	PGNSP PGUID 7126 790 f 0 ));
DATA(insert (	405		cdbhash_complex_ops	PGNSP PGUID 7127 7198 f 0 ));
DATA(insert (	405		cdbhash_uuid_ops	PGNSP PGUID 7128 2950 f 0 ));
DATA(insert (	405		cdbhash_enum_ops	PGNSP PGUID 7129 3500 f 0 ));
