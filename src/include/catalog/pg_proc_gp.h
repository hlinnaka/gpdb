...
DATA(insert OID = 6169 ( cdblegacyhash_uuid  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "2950" _null_ _null_ _null_ _null_ cdblegacyhash_uuid _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_complex(complex) => int4 */
DATA(insert OID = 6170 ( cdblegacyhash_complex  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "7198" _null_ _null_ _null_ _null_ cdblegacyhash_complex _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* cdblegacyhash_anyrange(anyrange) => int4 */
DATA(insert OID = 6171 ( cdblegacyhash_anyrange  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "3831" _null_ _null_ _null_ _null_ cdblegacyhash_anyrange _null_ _null_ _null_ n a ));
DESCR("Legacy cdbhash function");

/* hashtid(tid) => int4 */
DATA(insert OID = 6172 ( hashtid  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "27" _null_ _null_ _null_ _null_ hashtid _null_ _null_ _null_ n a ));
DESCR("hash function for tid");

/* bithash(bit) => int4 */
DATA(insert OID = 6173 ( bithash  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1560" _null_ _null_ _null_ _null_ bithash _null_ _null_ _null_ n a ));
DESCR("hash function for bit");

/* bithash(varbit) => int4 */
DATA(insert OID = 6174 ( bithash  PGNSP PGUID 12 1 0 0 0 f f f f t f i 1 0 23 "1562" _null_ _null_ _null_ _null_ bithash _null_ _null_ _null_ n a ));
DESCR("hash function for bit varbit");

/* pg_get_table_distributedby(oid) => text */
DATA(insert OID = 6175 ( pg_get_table_distributedby  PGNSP PGUID 12 1 0 0 0 f f f f t f s 1 0 25 "26" _null_ _null_ _null_ _null_ pg_get_table_distributedby _null_ _null_ _null_ n a ));
