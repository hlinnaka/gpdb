...
DATA(insert (	7109 27 27 1 6152));		/* tid */
DATA(insert (	7110 1114 1114 1 6153));	/* timestamp */
DATA(insert (	7111 1184 1184 1 6154));	/* timestamptz */
DATA(insert (	7112 1082 1082 1 6155));	/* date */
DATA(insert (	7113 1083 1083 1 6156));	/* time */
DATA(insert (	7114 1266 1266 1 6157));	/* timetz */
DATA(insert (	7115 1186 1186 1 6158));	/* interval */
DATA(insert (	7116 702 702 1 6159));		/* abstime */
DATA(insert (	7117 703 703 1 6160));		/* reltime */
DATA(insert (	7118 704 704 1 6161));		/* tinterval */
DATA(insert (	7119 869 869 1 6162));		/* inet */
DATA(insert (	7120 829 829 1 6163));		/* macaddr */
DATA(insert (	7121 1560 1560 1 6164));	/* bit */
DATA(insert (	7122 1562 1562 1 6164));	/* varbit */
DATA(insert (	7123 16 16 1 6165));		/* bool */
DATA(insert (	7124 2277 2277 1 6166));	/* anyarray */
DATA(insert (	7125 30 30 1 6167));		/* oidvector */
DATA(insert (	7126 790 790 1 6168));		/* money */
DATA(insert (	7127 7198 7198 1 6169));	/* complex */
DATA(insert (	7128 2950 2950 1 6170));	/* uuid */
DATA(insert (	7129 3500 3500 1 6171));	/* enum */
