...
DATA(insert OID = 7122 (	405		cdbhash_macaddr_ops	PGNSP PGUID ));
// FIXME: should bit and varbit be in the same opfamily?
DATA(insert OID = 7123 (	405		cdbhash_bit_ops	PGNSP PGUID ));
DATA(insert OID = 7124 (	405		cdbhash_varbit_ops	PGNSP PGUID ));
DATA(insert OID = 7125 (	405		cdbhash_bool_ops	PGNSP PGUID ));
DATA(insert OID = 7126 (	405		cdbhash_array_ops	PGNSP PGUID ));
DATA(insert OID = 7127 (	405		cdbhash_oidvector_ops	PGNSP PGUID ));
DATA(insert OID = 7128 (	405		cdbhash_cash_ops	PGNSP PGUID ));
DATA(insert OID = 7129 (	405		cdbhash_complex_ops	PGNSP PGUID ));

/* hash opfamily for TID */
DATA(insert OID = 7130 (	405		tid_ops		PGNSP PGUID ));
DATA(insert OID = 7131 (	405		bit_ops		PGNSP PGUID ));
DATA(insert OID = 7132 (	405		varbit_ops	PGNSP PGUID ));
