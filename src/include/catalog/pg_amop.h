...
DATA(insert (	7109 27 27 1 s 387 405 0 ));		/* tid */
DATA(insert (	7110 1114 1114 1 s 2060 405 0 ));	/* timestamp */
DATA(insert (	7111 1184 1184 1 s 1320 405 0 ));	/* timestamptz */
DATA(insert (	7112 1082 1082 1 s 1093 405 0 ));	/* date */
DATA(insert (	7113 1083 1083 1 s 1108 405 0 ));	/* time */
DATA(insert (	7114 1266 1266 1 s 1550 405 0 ));	/* timetz */
DATA(insert (	7115 1186 1186 1 s 1330 405 0 ));	/* interval */
DATA(insert (	7116 702 702 1 s 560 405 0 ));		/* abstime */
DATA(insert (	7117 703 703 1 s 566 405 0 ));		/* reltime */
DATA(insert (	7118 704 704 1 s 811 405 0 ));		/* tinterval */
DATA(insert (	7119 869 869 1 s 1201 405 0 ));		/* inet */
DATA(insert (	7120 829 829 1 s 1220 405 0 ));		/* macaddr */
DATA(insert (	7121 1560 1560 1 s 1784 405 0 ));	/* bit */
DATA(insert (	7122 1562 1562 1 s 1804 405 0 ));	/* varbit */
DATA(insert (	7123 16 16 1 s 91 405 0 ));			/* bool */
DATA(insert (	7124 2277 2277 1 s 1070 405 0 ));	/* anyarray */
DATA(insert (	7125 30 30 1 s 649 405 0 ));		/* oidvector */
DATA(insert (	7126 790 790 1 s 900 405 0 ));		/* money */
DATA(insert (	7127 7198 7198 1 s 6469 405 0 ));	/* complex */
DATA(insert (	7128 2950 2950 1 s 2972 405 0 ));	/* uuid */
DATA(insert (	7129 3500 3500 1 s 3516 405 0 ));	/* enum */
