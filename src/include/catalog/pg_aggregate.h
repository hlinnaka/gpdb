...
/* avg */
DATA(insert ( 2100	n 0 int8_avg_accum	numeric_poly_avg -					int8_avg_accum		int8_accum_inv		numeric_avg		f f 0	2281	48		2281	48	_null_ _null_ ));
...
/* sum */
DATA(insert ( 2107	n 0 int8_avg_accum	numeric_poly_sum -					int8_avg_accum		int8_accum_inv		numeric_sum		f f 0	2281	48		2281	48	_null_ _null_ ));
...
DATA(insert ( 2723	n 0 numeric_accum	numeric_var_pop			-				numeric_accum		numeric_accum_inv	numeric_var_pop			f f 0		2281	128		0		0	_null_ _null_ ));
