...
Datum cdblegacyhash_anyrange(PG_FUNCTION_ARGS);
...
Oid
get_legacy_cdbhash_opclass_for_base_type(Oid typid)
{
	char	   *opclass_name;

	// FIXME: look through domains and array/range/enum types */
	...
	switch (typid)
	{
		...
		case ANYARRAYOID:
			opclass_name = "cdbhash_array_ops";
			break;
		case ANYENUMOID:
			opclass_name = "cdbhash_int4_ops";
			break;
...
Datum
cdblegacyhash_anyrange(PG_FUNCTION_ARGS)
{
