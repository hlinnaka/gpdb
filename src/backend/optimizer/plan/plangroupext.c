							 ...
							 Plan *lefttree)
{
	...
	context->path->locus.distkey_h = copyObject(context->input_locus.distkey_h);
	context->path->locus.distkey_oj = copyObject(context->input_locus.distkey_oj);
					   ...
					   Plan *lefttree)
{
	...
	context->input_locus.distkey_h = copyObject(context->path->locus.distkey_h);
	context->input_locus.distkey_oj = copyObject(context->path->locus.distkey_oj);
	context->pathkeys = NIL;
