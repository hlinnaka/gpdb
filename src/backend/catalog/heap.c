...
List	*binary_upgrade_next_heap_pg_class_oid = NULL;
List	*binary_upgrade_next_toast_pg_class_oid = InvalidOid;
/*
						 ...
						 int64 *persistentSerialNum)
{
	...
	if (!OidIsValid(relid))
	{
		 ...
		 * supplied.
		 */
		if (IsBinaryUpgrade && (binary_upgrade_next_heap_pg_class_oid != NULL) &&
