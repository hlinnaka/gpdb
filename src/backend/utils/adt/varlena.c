...
/*
 * The PostgreSQL implementation of this converts the whole input string into
 * wchars first. That puts a limit of about 250 MB for the maximum input size
 * that it can handle. We have modified this in GPDB, to deal with larger
 * inputs.
 *
 * In this GPDB version, we maintain a smaller rolling buffer.
 */
typedef struct
{
